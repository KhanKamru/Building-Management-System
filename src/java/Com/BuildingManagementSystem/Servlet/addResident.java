    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
       boolean emptyError = false;
        ...
        if (emptyError == false) {
            ...
            Resident resident = new Resident(room, name, phone, pass);
            if (rd.addResident(resident)) {
                out.println(ResidentDao.htmlAndCss("success", "Resident Added Successfully"));
                rd.addMaintenance(room);
            } 
        }
